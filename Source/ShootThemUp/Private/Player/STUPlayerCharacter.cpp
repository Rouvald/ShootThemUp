    ...
    : Super(ObjInit)
{
    ...
    CameraCollisionComponent = CreateDefaultSubobject<USphereComponent>("SphereCollisionComponent");
...
void ASTUPlayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    ...
    //PlayerInputComponent->BindAction("Crouch", IE_Pressed, this, &ASTUPlayerCharacter::OnCrouch);
...
/*void ASTUPlayerCharacter::OnCrouch()
{
...
bool ASTUPlayerCharacter::IsCrouching() const
{
